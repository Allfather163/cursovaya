public class Store {
        ...
        public Store() {
            workerCorp[0] = new Worker("Иван", "Иванов", "Иванович",  100000);
            workerCorp[1] = new Worker("Николай", "Николаев", "Николаевич", 50300);
            workerCorp[2] = new Worker("Сергей", "Сергеев", "Сергеевич",  150000);
            workerCorp[3] = new Worker("Александр", "Александров", "Александрович",  123450);
            workerCorp[4] = new Worker("Дмитрий", "Дмитриев", "Дмитриевич",  85000);
            workerCorp[5] = new Worker("Егор", "Егоров", "Егорович",  90000);
            workerCorp[6] = new Worker("Антон", "Антонов", "Антонович",  95000);
            workerCorp[7] = new Worker("Павел", "Павлов", "Павлович",  115000);
            workerCorp[8] = new Worker("Никита", "Никитов", "Никитович",  114000);
            workerCorp[9] = new Worker("Михаил", "Михаилов", "Михайлович",  99000);
        }
        public void printAllEmp() {
            for (Worker employee : workerCorp) {
